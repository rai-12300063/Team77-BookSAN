...
const InstructorQuizEditor = () => {
  ...
  const fetchQuiz = useCallback(async () => {
    try {
      // Use instructor endpoint to bypass module completion checks
      const response = await axiosInstance.get(`/api/quiz/instructor/${quizId}`);
  ...
  const saveQuiz = async () => {
    ...
    try {
      ...
      // Instructor uses instructor endpoint
      const response = await axiosInstance.put(`/api/quiz/instructor/${quizId}`, {
        questions: questions
      });
