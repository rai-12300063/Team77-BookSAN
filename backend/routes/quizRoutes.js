...
router.get('/admin/all', getAllQuizzes);

// Get a specific quiz for editing (admin - no module completion check)
router.get('/admin/:quizId', getQuizForEdit);

// Create new quiz in a course (admin can create in ANY course)
router.post('/admin/course/:courseId', createQuiz);

// Update existing quiz
router.put('/admin/:quizId', updateQuiz);

// Delete quiz
router.delete('/admin/:quizId', deleteQuiz);
...
router.get('/instructor/my-quizzes', getInstructorQuizzes);

// Create new quiz in instructor's assigned course
router.post('/instructor/course/:courseId', createInstructorQuiz);

// Update quiz in instructor's assigned course
router.put('/instructor/:quizId', updateInstructorQuiz);

// Delete quiz in instructor's assigned course
router.delete('/instructor/:quizId', deleteInstructorQuiz);
