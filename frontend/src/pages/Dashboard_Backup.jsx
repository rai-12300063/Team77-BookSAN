            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              >
                ...
                Test Modules System
                      ...
                      alert(`✅ ${data.message}\n\n📊 Module Status:\n• Total Modules: ${data.totalModules}\n• All modules have content!\n\nSample modules:\n${data.moduleDetails.map(m => `• ${m.title} (${m.contentCount} items, ${m.duration} min)`).join('\n')}`);
                    } else {
                      alert(`✅ Success! ${data.message}\n\n📊 Results:\n• Total Modules: ${data.totalModules}\n• Newly Populated: ${data.newlyPopulated}\n• Previously Populated: ${data.populatedModules}`);
                    }
                    ...
                    const errorMsg = error.response?.data?.message || 'Failed to populate modules';
