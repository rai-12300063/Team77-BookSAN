        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-3">
              ...
              <Link 
                to="/tasks" 
                className="block w-full bg-gray-600 text-white text-center py-2 rounded-md hover:bg-gray-700 transition duration-200"
              >
                Manage Tasks
              </Link>
              <Link 
                to="/profile" 
                className="block w-full border border-gray-300 text-gray-700 text-center py-2 rounded-md hover:bg-gray-50 transition duration-200"
              >
                Update Profile
              </Link>
            </div>
